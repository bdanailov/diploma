...
|    |Име          | Mерна единица | Описание                             |
|:---|:-----------:|--------------:|:-------------------------------------|
|1   |leftSensor   |cm             | Дистанция измерена от левия сензор   |
|2   |middleSensor |cm             | Дистанция измерена от средния сензор |
|3   |roghtSensor  |cm             | Дистанция измерена от десния сензор  |
