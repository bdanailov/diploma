...
Вече сме задали метод на обучение на мрежата. Време е да изпълним самото обучение. Както е показано фигура 3.13 , избираме от "Мениджъра на задачи" -> *Perform training*
...
Тестването на генерираната и обучената мрежа може да бъде направено като изберем задачата *Calculate outputs* от *Мениджъра на задачи*
