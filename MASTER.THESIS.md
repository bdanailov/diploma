...
Невронните мрежи са отличен инструмен, приложим при мобилни роботи, избягващи препятствия, които работят с неточна информация. Архитектурата на Невронна мрежа с обратно разпростанение на грешката може да бъде имплентирано в системи за реално време, като резултата ще бъде система която ще бъде надеждна и устойчива на грешки.

Използваните по време на изпитанията датчици за дистанция, MB1010 LV-MaxSonar-EZ1, отчитат грешни разстояния на случаен принцип. За да получим верни отчитания трябва да ги използваме в контролирана среда. Предметите трябва да са по-големи по обем, да имат гладки повърности и прочие.

Въпреки недостатъците на предложената невронна мрежа, тя е едно много добро начало за разботването на една наистина автономна система за управление. Невронна мрежа с обратно разпростанение на грешката е много по-добро решение, но сме ограничени от хардуерните параметри на тестовия робот.

За по-сложни приложения можем да използваме повече сензори за дистанация едновременно, жироскопи, компас и други, за да си гарантираме по-добро разположение на движещия се обект. С повече сензори за дистанция ще придобием по-ясно разбиране на забикалящата ни среда, стига това да бъде по способностите на платформата за разработка.
